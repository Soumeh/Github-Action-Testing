...
import org.solstice.rollingStones.content.item.HoningStoneItem;
...
public class ModItems {
    ...
    public static final DeferredItem<Item> TIER_THREE_DURABILITY_SMITHING_STONE = register("tier_three_durability_smithing_stone",
            settings -> new HoningStoneItem(Upgrades.DURABILITY, 3, settings),
            new Item.Settings()
                    .rarity(Rarity.RARE)
    );
